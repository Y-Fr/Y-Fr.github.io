        ...
        (0, a.default)(s.default, {
          ...
          sdkLoader: function (e, t, n) {
            t in window && window[t]
              ...
              : s.default.dynamicLoadSource(e, function () {
        ...
        i = {
          ...
          parse: function (e, t) {
            return String(e).replace(
              new RegExp(":(" + Object.keys(i.maps).join("|") + "):", "ig"),
              function (e, n) {
    ...
    function (e, t, n) {
      ...
      function l(e, t, n, r) {
        if (((n = v(n)), "href" === t || "src" === t)) {
          ...
          if (((T.lastIndex = 0), T.test(n) && (($.lastIndex = 0), $.test(n))))
            return "";
...
*/
      ...
      (i.prototype.init = function (e) {
        ...
        return (
          e &&
            ...
            (t.i18n = (0, f.default)(e.lang || A.default.lang, e.langMode)),
            (t.cfg = e),
        ...
        (i.prototype._init = function () {
          ...
          try {
            ...
            var c = $.ds,
              f = r ? "&q=" + (0, h.RandomStr)() : "";
            ($.params =
              "?d=" + (c.indexOf(n) > -1 ? n : "mp") + "&v=" + h.VERSION + f),
              ($.hide = "hide" === n),
            ...
            if ((p = p instanceof HTMLElement ? p : d[d.length - 1] || null)) {
              (e.$el = (0, A.default)(p)),
                ...
                (e.cfg.requiredFields = e.cfg.requiredFields.filter(function (
                  e
                ) {
                  return h.defaultMeta.indexOf(e) > -1;
                }));
      ...
      (i.prototype.Q = function (e) {
        ...
        (i.prototype.bind = function () {
            ...
            c = function (e) {
              ...
              t.html(n.join("")),
                ...
                t.find("i").on("click", function (e) {
                  e.preventDefault(),
                    w(o[0], " :" + (0, A.default)(this).attr("title") + ":");
                });
            };
          (e.$emoji = {
            show: function () {
                    ...
                    e.cfg.enableQQ &&
                      ...
                      (n.val() && !isNaN(n.val())
                        ...
                        : A.default.store.get(h.QQCacheKey) &&
                          A.default.store.get(h.QQCacheKey).nick != n.val() &&
          ...
          e.Q(e.cfg.path)
            ...
            .then(function (t) {
              t > 0
                ? (e.$el.find(".vcount").show().find(".vnum").text(t), _())
                : e.$loading.hide();
            })
            .catch(function (t) {
          ...
          var j = function () {
            ...
            T = function (t, n, r) {
              ...
              var s = t.get("link")
                  ...
                  : "",
                l = A.default.escape(
                  (0, C.default)(t.get("nick").substring(0, 30))
                ),
                c = s
    ...
    function (e, t, n) {
      ...
      !(function (i) {
        ...
        function g(e, t) {
          ...
          return (
            (r = p(o.concat(h(t)), 512 + 8 * t.length)), d(p(a.concat(r), 640))
          );
        }
        function m(e) {
          var t,
      ...
      t.default = function (e) {
        return (
          ...
          new Promise(function (t, n) {
            ...
            s.send(
              "post" == e.method ? e.body : "get" == e.method ? "" : a(e.body)
            );
          })
        );
      };
              ...
              i &&
                a.push.apply(
                  ...
                  i[t]
                    ...
                    : "" + i === i
                    ? /</.test(i)
                      ? (((o = e.createElement(o)).innerHTML = i), o.children)
                      : o
                      ? (o = r(o)[0])
                        ? o[n](i)
                        : a
        ...
        return u(e, function (e, t, n, u, l) {
          ...
          if (
            (!0 === c
              ...
              : "function" == typeof c
              ? (f = c(u))
              : c instanceof RegExp && (f = c.test(u)),
            !0 !== f && (f = !1),
            (u = s(n, u)))
          ) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        return (
          "string" == typeof e ||
          ("object" == typeof e && (a ? i(e) : "[object String]" === o.call(e)))
        );
      };
    },
    function (e, t, n) {
      ...
      !(function (e, n) {
                ...
                if (t) {
                  ...
                  for (u = 0; u < D; u++) {
                    (this.lexer.state.top = !1),
                      (m.items[u].tokens = this.lexer.blockTokens(
                        m.items[u].text,
                        []
                      ));
                ...
                if (t) {
                  ...
                  if (n.header.length === n.align.length) {
                    ...
                    for (u = n.rows.length, r = 0; r < u; r++)
                      n.rows[r] = h(n.rows[r], n.header.length).map(function (
                        e
                      ) {
                        return { text: e };
                      });
                    for (u = n.header.length, i = 0; i < u; i++)
                      (n.header[i].tokens = []),
                    ...
                    for (
                      ...
                      if ((o = r[1] || r[2] || r[3] || r[4] || r[5] || r[6]))
                        if (((a = o.length), r[3] || r[4])) s += a;
                          ...
                          if (!((s -= a) > 0)) {
                            if (
                              ((a = Math.min(a, a + s + l)), Math.min(u, a) % 2)
                            ) {
        ...
        (L._label = /(?!\s*\])(?:\\.|[^\[\]\\])+/),
          ...
          (L.gfm.table = c(L.gfm.table)
            ...
            .replace("tag", L._tag)
            .getRegex()),
          (L.gfm.paragraph = c(L._paragraph)
            .replace("hr", L.hr)
            .replace("heading", " {0,3}#{1,6} ")
            .replace("|lheading", "")
        ...
        var U = (function () {
            function t(t) {
              ...
              this.options.pedantic
                ? ((n.block = L.pedantic), (n.inline = N.pedantic))
                : this.options.gfm &&
                  ((n.block = L.gfm),
                  this.options.breaks
                    ? (n.inline = N.breaks)
                        ...
                        this.options.extensions &&
                          ...
                          (function () {
                            var t = 1 / 0,
                              r = e.slice(1),
                              i = void 0;
                            n.options.extensions.startInline.forEach(function (
                              e
                            ) {
                              "number" ==
                                typeof (i = e.call({ lexer: this }, r)) &&
                    ...
                    switch (p.type) {
                      ...
                      case "heading":
                        w += this.renderer.heading(
                          ...
                          p.depth,
                          l(this.parseInline(p.tokens, this.textRenderer)),
                          this.slugger
                        );
                        continue;
                      case "code":
                                  ...
                                  ? ((m.tokens[0].text =
                                    ...
                                    m.tokens[0].tokens &&
                                      ...
                                      (m.tokens[0].tokens[0].text =
                                        D + " " + m.tokens[0].tokens[0].text))
                                  : m.tokens.unshift({ type: "text", text: D })
                                : (g += D)),
                      ...
                      case "text":
                        for (
                          f = p.tokens ? this.parseInline(p.tokens) : p.text;
...
*/
    ...
    function (e, t, n) {
      ...
      function E(e, t) {
        ...
        return i(
          Y.call(Y.call(e, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, F),
          "single",
          t
        );
      }
      ...
      var T = "function" == typeof Map && Map.prototype,
        ...
        fe =
          "function" == typeof Symbol &&
          Symbol.toStringTag &&
          (typeof Symbol.toStringTag === ce ? "object" : "symbol")
            ? Symbol.toStringTag
            : null,
      ...
      e.exports = function e(t, n, F, T) {
        function I(t, n, r) {
          if ((n && ((T = oe.call(T)), T.push(n)), r)) {
            var i = { depth: P.depth };
            return (
              v(P, "quoteStyle") && (i.quoteStyle = P.quoteStyle),
              e(t, i, F + 1, T)
            );
          }
          return e(t, P, F + 1, T);
        ...
        if ((void 0 === F && (F = 0), F >= W && W > 0 && "object" == typeof t))
        ...
        if (l(t)) {
          ...
          return "cause" in t && !pe.call(t, "cause")
            ? "{ [" +
                String(t) +
                "] " +
                ie.call(re.call("[cause]: " + I(t.cause), se), ", ") +
                " }"
            : 0 === se.length
            ? "[" + String(t) + "]"
            : "{ [" + String(t) + "] " + ie.call(se, ", ") + " }";
    ...
    function (e, t, n) {
      ...
      function a(e) {
        (e = o(e || {})),
          e.stripIgnoreTag &&
            (e.onIgnoreTag, (e.onIgnoreTag = s.onIgnoreTagStripAll)),
          ...
          !1 === e.css
            ? (this.cssFilter = !1)
            : ((e.css = e.css || {}), (this.cssFilter = new u(e.css)));
      }
      var u = n(7).FilterCSS,
        s = n(31),
        l = n(32),
